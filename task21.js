...
let magicians_array = ['peter', 'pakoo', 'coldbee', 'surpal'];
function make_magician(magicians_array) {
...
let magicians_array1 = ['peter', 'pakoo', 'coldbee', 'surpal'];
function show_magician1(magicians_array1) {
...
let magicians_array2 = ['peter', 'pakoo', 'coldbee', 'surpal'];
function show_magician2(magicians_array2) {
    let newMagacian_array = [];
